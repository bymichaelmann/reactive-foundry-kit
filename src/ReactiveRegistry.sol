...
library ReactiveRegistry {
    ...
    address public constant SEPOLIA_SYSTEM_CONTRACT =
        0x0000000000000000000000000000000000000000;

    /// @notice Sepolia subscription proxy address (TBD - update when documented)
    address public constant SEPOLIA_SUBSCRIPTION_PROXY =
        0x0000000000000000000000000000000000000000;
    ...
    address public constant LASNA_CALLBACK_PROXY =
        0xc9f36411C9897e7F959D99ffca2a0Ba7ee0D7bDA;

    /// @notice Lasna system contract address (TBD)
    address public constant LASNA_SYSTEM_CONTRACT =
        0x0000000000000000000000000000000000000000;

    /// @notice Lasna subscription proxy address (TBD)
    address public constant LASNA_SUBSCRIPTION_PROXY =
        0x0000000000000000000000000000000000000000;
    ...
    function _getChainConfigs()
        internal
        pure
        returns (ChainConfig[2] memory configs)
    {
